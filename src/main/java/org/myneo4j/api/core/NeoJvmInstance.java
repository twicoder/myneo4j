...
import org.myneo4j.impl.core.NeoModule;
import org.myneo4j.impl.event.EventModule;
import org.myneo4j.impl.nioneo.xa.NioNeoDbPersistenceSource;
import org.myneo4j.impl.persistence.IdGeneratorModule;
import org.myneo4j.impl.persistence.PersistenceModule;
import org.myneo4j.impl.persistence.PersistenceSource;
import org.myneo4j.impl.transaction.TxModule;

class NeoJvmInstance
{

    private static final String NIO_NEO_DB_CLASS =
        "org.myneo4j.impl.nioneo.xa.NeoStoreXaDataSource";
